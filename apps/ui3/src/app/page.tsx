    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-left">
              <h1
                className="text-6xl md:text-7xl font-serif mb-8 text-black leading-tight"
              ...
              >
                First impressions matter. We create clean, organized business plans that make it
                easy for investors to say "yes" to your vision.
              </p>
              ...
              <div className="flex flex-wrap gap-6 mt-12 pt-8 border-t border-gray-200">
                ...
                <span className="text-gray-300">•</span>
                <span className="text-sm text-gray-600 font-light">
                  Created for pitches and presentations
                </span>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-5 gap-16 items-center">
            <div className="md:col-span-2 space-y-8">
              <div>
                ...
                <h2
                  className="text-4xl font-serif mb-6 text-black"
                  style={{ fontFamily: 'Didot, serif' }}
                >
            ...
            <div className="md:col-span-2 order-1 md:order-2 space-y-8">
              <div>
                ...
                <p
                  ...
                  style={{ fontFamily: 'Helvetica Neue, sans-serif' }}
                >
                  We refine your information to ensure the flow and structure make sense to an
                  outsider.
                </p>
              </div>
            </div>
      ...
      <section className="py-24 bg-gradient-to-br from-purple-50 to-pink-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2
            className="text-5xl font-serif mb-16 text-black"
            style={{ fontFamily: 'Didot, serif' }}
          >
            What We Create
          </h2>
          ...
          <p
            className="text-gray-600 max-w-2xl mx-auto font-light italic"
            style={{ fontFamily: 'Helvetica Neue, sans-serif' }}
          >
      ...
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2
            className="text-5xl font-serif mb-20 text-black text-center"
            style={{ fontFamily: 'Didot, serif' }}
          >
            What's In The Box
          </h2>
          ...
          <div className="space-y-16">
            ...
            <div className="md:ml-0 md:mr-auto md:w-2/3 bg-gradient-to-br from-pink-50 to-white p-10 border border-gray-200">
              <h3
                className="text-3xl font-serif mb-4 text-black"
                style={{ fontFamily: 'Didot, serif' }}
              >
                The Design Assets
              </h3>
            ...
            <div className="md:ml-0 md:mr-auto md:w-2/3 bg-gradient-to-br from-mint-50 to-white p-10 border border-gray-200">
              ...
              <p
                ...
                style={{ fontFamily: 'Helvetica Neue, sans-serif' }}
              >
                We include a revision round to fine-tune the language and ensure it captures your
                voice perfectly.
              </p>
            </div>
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-purple-50 to-pink-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-white p-12 border-2 border-black inline-block">
            <div
              className="text-6xl font-serif mb-4 text-black"
              style={{ fontFamily: 'Didot, serif' }}
            >
      ...
      <section className="py-24 bg-black text-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="md:w-2/3">
            ...
            <p
              className="text-xl mb-10 opacity-90 font-light leading-relaxed"
              style={{ fontFamily: 'Helvetica Neue, sans-serif' }}
            >
