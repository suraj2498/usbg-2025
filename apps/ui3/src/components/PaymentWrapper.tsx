...
export function PaymentWrapper({ email, amount, metadata }: PaymentWrapperProps) {
  ...
  if (isLoading) {
    return (
      <div className="w-full min-h-screen flex items-center justify-center p-8 bg-gradient-to-br from-primary/5 via-white to-primary-light/10">
  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-white to-primary-light/10 py-12 px-4">
