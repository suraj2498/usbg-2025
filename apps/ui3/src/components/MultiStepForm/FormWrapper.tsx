...
export default function MultiStepForm() {
  ...
  return (
    <>
      {showPayment ? (
        <div className="w-full min-h-[90vh] flex items-center justify-center p-8">
          <PaymentWrapper
            ...
            <div className="px-12 py-8">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <h1
                    className="text-4xl font-serif text-black mb-3"
          ...
          <div className="bg-white border border-gray-200 px-12 py-16">
            ...
            {process.env.NODE_ENV === 'development' && (
              <div className="mt-12 p-6 bg-gradient-to-br from-pink-50 to-purple-50 border border-gray-200">
                <p
                  className="text-xs font-serif text-gray-700 mb-3"
                  style={{ fontFamily: 'Didot, serif' }}
                >
                  Debug Info:
                </p>
                <pre
                  className="text-xs text-gray-800 overflow-auto font-light"
                  style={{ fontFamily: 'Helvetica Neue, sans-serif' }}
                >
