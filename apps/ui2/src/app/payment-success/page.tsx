    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-white to-primary-light/10 flex items-center justify-center p-4">
      ...
      <div className="max-w-4xl w-full bg-white rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-green-500 to-green-600 px-8 py-12 text-center text-white">
          ...
          <h1 className="text-5xl lg:text-6xl font-bold mb-4">Payment Successful!</h1>
          <p className="text-2xl opacity-90">🎉 Your order has been confirmed</p>
        </div>
          ...
          {paymentIntent && (
            <div className="mb-10 p-8 bg-gradient-to-br from-primary/5 to-primary-light/10 border-2 border-primary/20 rounded-2xl">
              ...
              <div className="bg-white rounded-xl p-4 border border-gray-200">
                ...
                <p className="text-base font-mono text-gray-800 break-all">{paymentIntent}</p>
              </div>
            </div>
          )}
          ...
          <div className="mb-10">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl p-6 border-2 border-primary/20 text-center">
                ...
                <h4 className="text-lg font-bold text-gray-900 mb-2">1. Email Confirmation</h4>
              ...
              <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl p-6 border-2 border-primary/20 text-center">
                ...
                <h4 className="text-lg font-bold text-gray-900 mb-2">2. Plan Preparation</h4>
                <p className="text-gray-600">
              ...
              <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-2xl p-6 border-2 border-primary/20 text-center">
                ...
                <h4 className="text-lg font-bold text-gray-900 mb-2">3. Expert Support</h4>
                <p className="text-gray-600">
...
export default function PaymentSuccessPage() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gradient-to-br from-primary/5 via-white to-primary-light/10 flex items-center justify-center">
